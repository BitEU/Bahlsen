@echo off
REM Build script for Bahlsen: UNIVAC Enigma Brute-Forcer
REM Unified script for MSVC and MinGW compilation
REM Supports Windows and UNIVAC cross-compilation

echo.
echo ========================================
echo   Bahlsen - Unified Build Script
echo   UNIVAC Enigma Brute-Forcer
echo ========================================
echo.
...
:BUILD_START
echo.
echo Building Bahlsen: UNIVAC Enigma Brute-Forcer...
echo.
...
if exist Bahlsen_univac.exe del /Q Bahlsen_univac.exe
if exist Bahlsen_univac.o del /Q Bahlsen_univac.o
if exist *.o del /Q *.o
echo.
...
gcc -c -DUNIVAC -O2 -Wall main.c -o Bahlsen_univac.o
...
echo Linking...
gcc -o Bahlsen_univac.exe Bahlsen_univac.o
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo   - BSS initialization for global variables
    echo.
    goto :EOF
) else (
    echo.
...
REM Clean previous build artifacts
echo Cleaning previous build artifacts...
if exist Bahlsen_mingw.exe del /Q Bahlsen_mingw.exe
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo ========================================
    echo.
    echo Output: Bahlsen_mingw.exe

    REM Display file size
    for %%A in (Bahlsen_mingw.exe) do (
        echo File size: %%~zA bytes
    )
    echo.
    echo Optimization level: MAXIMUM (-O3 + LTO + native CPU^)
    echo.
    echo To run Bahlsen, type: Bahlsen_mingw.exe
    echo.
) else (
    echo.
    echo ========================================
...
cl /W4 /O2 /Fe:Bahlsen.exe main.c
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo ========================================
    echo.
    echo Output: Bahlsen.exe
    echo.
    echo To run: Bahlsen.exe
) else (
    echo.
    echo ========================================
    echo   BUILD FAILED
